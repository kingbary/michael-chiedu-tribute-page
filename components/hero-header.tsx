    ...
    <div className="flex flex-col items-center">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col items-center mt-6">
          ...
          <p className="text-lg font-semibold font-cormorant-garamond italic tracking-[-1.1%]">Beloved father, husband, mentor, and keeper of stories. His light remains.</p>
        </div>
        <div className="mt-5.75">
          <button className="inline-flex justify-center items-center h-10.5 px-7.75 text-[15px] text-primary font-jost font-medium uppercase tracking-[-1.1%] rounded-full border border-primary transition-colors duration-300 hover:bg-primary hover:text-background">Write a tribute</button>
        </div>
      </div>
    </div>
  );
